...
const Home: NextPage = () => {
  ...
  return (
    <main className='bg-gradient-to-r from-[#6FB2D2] to-[#D8D2CB] min-h-screen'> 
      <Navbar />
      ...
      <div className=''>
        <p className='text-xl sm:text-2xl py-4'>You own 0/1000 Gold Tokens</p>
          {renderButton()}
      </div>
      <div className='sm:ml-28'>
      {/* <img src="https://img.icons8.com/external-flat-wichaiwi/184/000000/external-token-gamefi-flat-wichaiwi.png"/> */}
      {/* <img src="https://img.icons8.com/external-ddara-lineal-ddara/184/000000/external-tokens-gaming-gambling-ddara-lineal-ddara.png"/> */}
